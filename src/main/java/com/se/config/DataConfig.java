...
public class DataConfig {
    ...
    //连接数据库的url
    public static final String url = "jdbc:mysql://127.0.0.1:3306/methodinvocation?serverTimezone=UTC&useSSL=false&rewriteBatchedStatements=true";
    //数据库驱动
    ...
    public static final String godClassOutputFilePath = "JavaMethodCallGraph\\JavaMethodCallGraph\\src\\main\\resources\\MiningResult\\godClassPath.txt";
    //单个待分析项目的目录
