...
public class DataConfig {
    ...
    //连接数据库的url
    public static final String url = "jdbc:mysql://localhost:3306/methodinvocation?serverTimezone=UTC&useSSL=false";
    //数据库驱动
    ...
    //所有待分析项目的父目录
    public static final String sourceProjectParentPath = "C:/Users/Zero/Desktop/Pro";
    //单个待分析项目的目录
    public static final String sourceProjectPath = "C:/Users/Zero/Desktop/Pro/MethodClone01";
    //API文档的路径
